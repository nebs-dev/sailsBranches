define({ "api": [
  ...
  {
    "type": "post",
    "url": "/api/branch/destroy/:id",
    "title": "destroy",
    "group": "Branch",
    "version": "0.0.0",
    "filename": "config/routes.js",
    "groupTitle": "Branch",
    "name": "PostApiBranchDestroyId"
  },
  {
    "type": "post",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "vertical",
            "description": "<p>vertical levels</p>"
          },
          {
            "group": "Parameter",
            "type": "integer",
            "optional": false,
            "field": "horizontal",
            "description": "<p>horizontal branches per level</p>"
          },
          {
            "group": "Parameter",
            "type": "float",
            "optional": false,
            "field": "price",
            "description": "<p>horizontal Licence price</p>"
          },
          {
            "group": "Parameter",
            "type": "boolean",
  ...
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "add_branch",
            "description": "<p>Permission to add branch</p>"
          },
          {
            "group": "Parameter",
            "type": "boolean",
            "optional": false,
            "field": "add_student",
            "description": "<p>Permission to add students to branch</p>"
          }
        ]
      }
    },
    ...
    "filename": "config/routes.js",
    "groupTitle": "Role",
    "name": "PostApiRoleUpdate"
  },
  {
    "type": "get",
    "url": "/api/tree/show",
    "title": "show single Tree",
    "group": "Tree",
    "version": "0.0.0",
    "filename": "config/routes.js",
    "groupTitle": "Tree",
  ...
  {
    "type": "post",
    "url": "/api/tree/destroy",
    "title": "destroy",
    "group": "Tree",
    "version": "0.0.0",
    "filename": "config/routes.js",
    "groupTitle": "Tree",
    "name": "PostApiTreeDestroy"
  },
  {
    "type": "get",
    "url": "/api/users",
